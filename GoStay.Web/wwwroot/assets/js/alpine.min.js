 ...
 !(function (e, t) {
        ...
        return Array.from(e.attributes)
            ...
            .map((e) => {
                const t = u(e.name),
                    ...
                    i = t.match(/:([a-zA-Z\-:]+)/),
                    r = t.match(/\.[^.\]]+(?=[^\]]*$)/g) || [];
                return { type: n ? n[1] : null, value: i ? i[1] : null, modifiers: r.map((e) => e.replace(".", "")), expression: e.value };
            })
            .filter((e) => !t || e.type === t);
    }
    function u(e) {
        return e.startsWith("otp") ? e.replace("otp", "x-on:") : e.startsWith(":") ? e.replace(":", "x-bind:") : e;
    }
    function d(e, t, n = !1) {
        if (n) return t();
        ...
        if (r && r.modifiers.includes("transition")) {
            ...
            (function (e, t, n) {
                const i = { duration: m(t, "duration", 150), origin: m(t, "origin", "center"), first: { opacity: 0, scale: m(t, "scale", 95) }, second: { opacity: 1, scale: 100 } };
                p(e, t, n, () => {}, i);
            })(e, (n = i ? n.filter((e, t) => t < n.indexOf("out")) : n), t);
        } else
            i.filter((e) => ["enter", "enter-start", "enter-end"].includes(e.value)).length > 0
                ? (function (e, t, n) {
    ...
    function f(e, t, n = !1) {
        ...
        if (r && r.modifiers.includes("transition")) {
            ...
            const i = n.includes("in") && n.includes("out");
            (function (e, t, n, i) {
                const r = { duration: n ? m(t, "duration", 150) : m(t, "duration", 150) / 2, origin: m(t, "origin", "center"), first: { opacity: 1, scale: 100 }, second: { opacity: 0, scale: m(t, "scale", 95) } };
                p(e, t, () => {}, i, r);
            })(e, (n = i ? n.filter((e, t) => t > n.indexOf("out")) : n), i, t);
        } else
            i.filter((e) => ["leave", "leave-start", "leave-end"].includes(e.value)).length > 0
                ? (function (e, t, n) {
    ...
    function y(e, t, i, r, s) {
        ...
        o.forEach((i, u) => {
            ...
            p
                ? (delete p.__x_for_key, (p.__x_for = f), e.updateElements(p, () => p.__x_for))
                : (d(
                      (p = (function (e, t) {
                    ...
                    if ((o !== window && o !== document) || document.body.contains(t)) {
                        if (
                            !(
                                ...
                                (i.includes("prevent") && s.preventDefault(), i.includes("stop") && s.stopPropagation(), i.includes("self") && s.target !== t)
                            )
                        ) {
    ...
    class ne {
        constructor(e, t = null) {
            ...
            (this.$data = o),
                ...
                r && !t && ((this.pauseReactivity = !0), (l = this.evaluateReturnExpression(this.$el, r)), (this.pauseReactivity = !1)),
                ...
                switch (i) {
                    ...
                    case "model":
                        !(function (e, t, i, r, s) {
                            ...
                            x(e, t, a, i, `${r} = rightSideOfExpression($event, ${r})`, () => n({}, s(), { rightSideOfExpression: E(t, i, r) }));
                        })(this, e, s, a, t);
                }
            });
        }
